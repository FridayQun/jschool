    ...
    <div class="wrapper">
      ...
      <div class="section">
        ...
        <div class="section-list-block">
          <ul class="section-list" style="padding-left: 20px;padding-right: 20px;">
        ...
        tabCut:function(){
          $('.section-title-bar .section-tags a').on('click',function(e){
            ...
            function render(data){
            	'<i class="icon user"></i>';
              var list = '<ul class="section-list" style="padding-left: 20px;padding-right: 20px;">';
              ...
              $('.section-list').children('li:eq(5)').css('clear','both');
