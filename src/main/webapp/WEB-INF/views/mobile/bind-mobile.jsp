  ...
  <div class="modify-pwd-box">
    <form class="modifyForm" action="#" method="post">
      <div class="form-group separator">
        <label for="mobile">请输入原手机</label>
        <input type="tel" name="mobile" id="mobile" value="${jkuser.phone}" placeholder="">
      </div>
      ...
      <div class="form-submit"><input type="submit" name="submit" value="确认提交"></div>
    </form>
  </div>
   	  ...
   	  if(phone!=''&&yzid!=''&&sid!=''){
     	  $.ajax({
              ...
              success: function(obj){
            	  if(obj==1){
            		  window.location.href=ctx+"/mobileuserino/tomonewdphone";
            	  }else{
            		  alert("验证码有误")
            	  }
              }
