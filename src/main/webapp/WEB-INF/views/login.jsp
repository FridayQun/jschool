  ...
  <div class="login-box">
    ...
    <div class="login-block">
      <div class="login-tab-label">
        <div class="label"><a class="active" href="#">登录</a></div><div class="label">
          <a href="#">注册</a></div>
      </div>
      <div class="login-tab-content">
        <div class="tab-content">
          <form class="loginForm" id="loginForm" action="${ctx}/login/login" method="post" autocomplete="off">
            ...
            <div class="form-notice"><a href="${ctx}/login/toForgetPw">忘记密码</a></div>
            <div class="form-submit"><input type="submit" id="loginsubmit" name="submit" value="登 录"></div>
          </form>
        </div>
        <div class="tab-content register hide">
          <form class="registerForm" action="${ctx}/login/register" method="post" autocomplete="off" data-validator-option="{stopOnError:false, timely:true,theme:'simple_bottom'}">
            ...
            <div class="form-group"><label for="captcha"><i class="icon form-captcha"></i></label><input type="text" name="yzcode" id="yzcode" placeholder="验证码" data-rule="验证码:required;"><button type="button" name="getCaptcha">获取验证码</button></div>
            ...
            <div class="form-group"><label for="confirmPassword"><i class="icon form-pd2"></i></label><input type="password" name="confirmPassword" id="confirmPassword1" value="" placeholder="确认密码" data-rule="确认密码:required;match(password);"></div>
            <div class="form-submit"><input type="submit" name="submit" id="registersubmit"  value="同意协议并注册"></div>
    ...
    $(function() {
      ...
      $('.login-tab-label a').on('click', function() {
        ...
        return false;
		  ...
		  //注册ajax提交
		  $('.registerForm').on('valid.form', function(e, form){
			  var phone=$("#phone").val();
      ...
      (getQueryString('register')) && $('.login-tab-label .label').eq(1).find('a').trigger('click');
	    ...
	    //登录失败
	    if($("#error").val()=='1'){
	  		$.DialogBySHF.Alert({ Width: 350, Height: 200, Title: "提示", Content: "登陆失败，用户名或密码错误！", ConfirmFun: function(){
	  			window.location.href=ctx+"/login/toLogin";
	  		} });
	  		return false;
	  	} else if($("#error").val()=='1'){
	  		$.DialogBySHF.Alert({ Width: 350, Height: 200, Title: "提示", Content: "登陆失败，您已经被禁言！", ConfirmFun: function(){
	  			window.location.href=ctx+"/login/toLogin";
	  		} });
	  		return false;
		}
